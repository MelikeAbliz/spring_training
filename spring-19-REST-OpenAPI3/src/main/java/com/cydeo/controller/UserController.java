...
public class  UserController {
    ...
    //consume-> accept as request xml, json format( api work with xml, json)
    //json is going to be able to serialization and deserialization this xml values by using dependency
